...
func (sq *SensorQuery) IDs(ctx context.Context) ([]uuid.UUID, error) {
	var ids []uuid.UUID
...
//
//	client.Sensor.Query().
//		Select(sensor.FieldSensorID).
//		Scan(ctx, &v)
func (sq *SensorQuery) Select(fields ...string) *SensorSelect {
	sq.fields = append(sq.fields, fields...)
	selbuild := &SensorSelect{SensorQuery: sq}
	selbuild.label = sensor.Label
...
func (sgb *SensorGroupBy) sqlScan(ctx context.Context, v any) error {
	for _, f := range sgb.fields {
		n, _ := strconv.ParseInt(f, 10, 32)
		if !sensor.ValidColumn(f) && n < 1 {
...
func (ss *SensorSelect) sqlScan(ctx context.Context, v any) error {
